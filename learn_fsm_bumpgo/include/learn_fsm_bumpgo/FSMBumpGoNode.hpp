...
#ifndef LEARN_FSM_BUMPGO__FSMBUMPGONODE_HPP_
#define LEARN_FSM_BUMPGO__FSMBUMPGONODE_HPP_
...
namespace learn_fsm_bumpgo
{
    ...
    class FSMBumpGoNode : public rclcpp::Node
    {
        public:
            FSMBumpGoNode();
        private:
...
#endif  // LEARN_FSM_BUMPGO__FSMBUMPGONODE_HPP_